...
kotlin {
    ...
    listOf(
        ...
        iosTarget.binaries.framework {
            baseName = "ktor-realtime-websocket"
            isStatic = true
        }
    }
...
android {
    ...
    namespace = "com.androidpoet.ktor.realtime.websocket"
...
mavenPublishing {
    ...
    signAllPublications()
    coordinates("io.github.androidpoet", "ktor-realtime-websocket", "1.0.0")

    pom {
        name.set("ktor-realtime-websocket")
        description.set("Protocol module for ktor-realtime-websocket in KtorBoost realtime.")
