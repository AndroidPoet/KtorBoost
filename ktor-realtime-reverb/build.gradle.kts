...
android {
    ...
    namespace = "com.androidpoet.ktor.realtime.reverb"
...
mavenPublishing {
    ...
    signAllPublications()
    coordinates("io.github.androidpoet", "ktor-realtime-reverb", "1.0.0")

    pom {
        name.set("ktor-realtime-reverb")
        description.set("Protocol module for ktor-realtime-reverb in KtorBoost realtime.")
