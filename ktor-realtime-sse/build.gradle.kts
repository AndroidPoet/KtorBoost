...
android {
    ...
    namespace = "com.androidpoet.ktor.realtime.sse"
...
mavenPublishing {
    ...
    pom {
        name.set("ktor-realtime-sse")
        description.set("Protocol module for ktor-realtime-sse in KtorBoost realtime.")
