...
kotlin {
    ...
    listOf(
        ...
        iosTarget.binaries.framework {
            baseName = "ktor-realtime-rsocket"
            isStatic = true
        }
    }
...
android {
    ...
    namespace = "com.androidpoet.ktor.realtime.rsocket"
...
mavenPublishing {
    ...
    signAllPublications()
    coordinates("io.github.androidpoet", "ktor-realtime-rsocket", "1.0.0")

    pom {
        name.set("ktor-realtime-rsocket")
        description.set("Protocol module for ktor-realtime-rsocket in KtorBoost realtime.")
