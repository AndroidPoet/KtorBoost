...
android {
    ...
    namespace = "com.androidpoet.ktor.realtime.mqtt"
...
mavenPublishing {
    ...
    signAllPublications()
    coordinates("io.github.androidpoet", "ktor-realtime-mqtt", "1.0.0")

    pom {
        name.set("ktor-realtime-mqtt")
        description.set("Protocol module for ktor-realtime-mqtt in KtorBoost realtime.")
