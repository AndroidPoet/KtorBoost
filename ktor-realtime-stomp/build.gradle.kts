...
android {
    ...
    namespace = "com.androidpoet.ktor.realtime.stomp"
...
mavenPublishing {
    ...
    coordinates("io.github.androidpoet", "ktor-realtime-stomp", "1.0.0")

    pom {
        name.set("ktor-realtime-stomp")
        description.set("Protocol module for ktor-realtime-stomp in KtorBoost realtime.")
