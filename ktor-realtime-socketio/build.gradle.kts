...
kotlin {
    ...
    listOf(
        ...
        iosTarget.binaries.framework {
            baseName = "ktor-realtime-socketio"
            isStatic = true
        }
    }
...
android {
    ...
    namespace = "com.androidpoet.ktor.realtime.socketio"
...
mavenPublishing {
    ...
    coordinates("io.github.androidpoet", "ktor-realtime-socketio", "1.0.0")

    pom {
        name.set("ktor-realtime-socketio")
        description.set("Protocol module for ktor-realtime-socketio in KtorBoost realtime.")
